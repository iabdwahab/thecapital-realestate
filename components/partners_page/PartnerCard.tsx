...
export default function PartnerCard({
  ...
  return (
    <article
      tabIndex={0}
      className={`${className} rounded-card-radius group hover:gradient-card-hover-light max-lg:focus:gradient-card-hover-light duration-hover-normal bg-background border-secondary-light relative flex flex-col items-center gap-2 border p-6 shadow-sm transition`}
    >
      <GradientCardBorder />
