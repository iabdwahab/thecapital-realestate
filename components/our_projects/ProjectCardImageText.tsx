...
export default function ProjectCardImageText() {
  return (
    <div className="group rounded-card-radius max-h-[350px] overflow-hidden shadow-sm">
      <div className="relative h-[350px] max-h-[350px] w-full bg-black transition-all duration-400 group-hover:max-h-[65%] group-active:max-h-[65%]">
        <Image
      ...
      <div className="text-primary text-body-small bg-background flex h-full flex-col gap-1 px-3 py-6 group-hover:max-h-[35%] group-active:max-h-[35%]">
